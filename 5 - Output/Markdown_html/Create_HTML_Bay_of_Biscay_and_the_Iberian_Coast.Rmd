...
reg_dat <- c("Bay of Biscay and the Iberian Coast","Gulf of Biscay", "North-Iberian Atlantic", "South-Iberian Atlantic","Gulf of Cadiz")
name_dat <- c("Bay of Biscay and the Iberian Coast","Gulf of Biscay", "North-Iberian Atlantic", "South-Iberian Atlantic","Gulf of Cadiz")
...
kable(hab, col.names = nam, caption="<p style='color: black'><strong>Table E1. Pressure and impact indicators that are applied by (sub-)region and subdivision area, including the spatial scale and period over which the indicators are calculated. C-square refers to a grid cell of dimensions 0.05° latitude * 0.05° longitude.</strong></p>",format = "html", table.attr = "style='width:100%;'", align='l') %>% 
