...
summary$text <- gsub("T1I5DC1", paste0(Tab1[5,2], "%"), summary$text)
...
pressure$text <- gsub("T3BHT1I5", paste0(Tab3[1,10], "%"), pressure$text)
...
if(ecoregion == "Bay of Biscay and the Iberian Coast"){ # remove text about landings value.
  ...
  FishingMet$text <- gsub("T4maxSAval", Tab4[[T4maxSAmet]][5], FishingMet$text)
}
```
`r FishingMet$text`
