...
nam <- c("MSFD broad habitat type", "Extent of habitat \n(*1000 km^2^)", "Total landings weight (x1000 kg)", "10%", "20%", "30%", "40%", "50%", "60%", "70%", "80%", "90%")
...
nam <- c("MSFD broad habitat type", "Extent of habitat \n(*1000 km^2^)", "Total landings value (x1000 euro)", "10%", "20%", "30%", "40%", "50%", "60%", "70%", "80%", "90%")
...
_**This region does not allow for the gear modification scenario, due to lacking sensitivity estimates**_
